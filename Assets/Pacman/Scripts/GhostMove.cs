...
public class GhostMove : MonoBehaviour {
    ...
    private PacmanGameManager _gm;

	//-----------------------------------------------------------------------------------------
	// variables end, functions begin
	void Start()
	{
	    _gm = GameObject.Find("Game Manager").GetComponent<PacmanGameManager>();
	...
	void FixedUpdate ()
	{
		...
		if(PacmanGameManager.gameState == PacmanGameManager.GameState.Game){
			animate ();
